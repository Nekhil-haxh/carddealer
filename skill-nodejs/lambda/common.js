...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = "These are the set of available commands, To set number of players, use command Set Players followed by\
        the number of players, To start distribution, use command distribute,. To get a number of cards, use command give followed by number of cards.\
